...
{
    public class VerifyHybridVoterViewModel : VerifyVoterBaseViewModel
    {
        // Model constructors
        public VerifyHybridVoterViewModel(NMVoter voter) : this(voter, null) { }
        public VerifyHybridVoterViewModel(NMVoter voter, VoterSearchModel SearchItems)
        {
            VoterItem = voter;
        ...
        public VerifyHybridVoterViewModel(VoterNavModel voterNav) : this(voterNav.Voter, voterNav.Search) { }
        ...
        {
            HybridMessage = "THIS VOTER IS NOT ELIGIBLE TO VOTE AT THIS SITE";

            BallotStyle = VoterItem.Data.BallotStyle;
            CurrentSite = AppSettings.System.SiteName;
        }
        #endregion
