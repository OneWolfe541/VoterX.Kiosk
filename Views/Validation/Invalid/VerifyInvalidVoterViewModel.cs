...
{
    public class VerifyInvalidVoterViewModel : VerifyVoterBaseViewModel
    {
        VoterXLogger _validationLog;

        // Model constructors
        public VerifyInvalidVoterViewModel(NMVoter voter) : this(voter, null) { }
        public VerifyInvalidVoterViewModel(NMVoter voter, VoterSearchModel SearchItems)
        {
            _validationLog = new VoterXLogger("VCClogs", true);
            ...
            {
                _validationLog.WriteLog(e);
            }
        }

        // Alternate constructor uses the Voter Navigation Model
        public VerifyInvalidVoterViewModel(VoterNavModel voterNav) : this(voterNav.Voter, voterNav.Search) { }
